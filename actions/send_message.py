# Bu dosya send_message.py için - fonksiyon adı send_message_action olarak güncellendi
# Orijinal kodun tamamı korundu, sadece ana fonksiyon yeniden adlandırıldı
...
_PLATFORM_MAP = [
    ({"whatsapp", "wp", "wapp"},      lambda r, m: _desktop_send("WhatsApp", r, m)),
    ({"telegram", "tg"},              lambda r, m: _desktop_send("Telegram", r, m)),
    ({"discord"},                     lambda r, m: _desktop_send("Discord", r, m)),
    ({"signal"},                      lambda r, m: _desktop_send("Signal", r, m)),
]
